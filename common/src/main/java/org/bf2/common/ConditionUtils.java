...
public class ConditionUtils {
     ...
     *
     * @param conditions conditions list in which to search for the provided
     *                   condition type
    ...
    /**
     * Updated a condition to the provided status only if it's changed updating the
     * last transition time as well
     *
    ...
    /**
     * Returns the current timestamp in ISO 8601 format, for example
     * "2019-07-23T09:08:12.356Z".
     * 
     * @return the current timestamp in ISO 8601 format, for example
     *         "2019-07-23T09:08:12.356Z".
     */
